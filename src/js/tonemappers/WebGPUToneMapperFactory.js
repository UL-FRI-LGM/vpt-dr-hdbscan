import { WebGPUArtisticToneMapper } from './WebGPUArtisticToneMapper.js';
...
export function WebGPUToneMapperFactory(which) {
    switch (which) {
        case 'artistic': return WebGPUArtisticToneMapper;
